...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/LyrexGit/pterodactyl-installer"}
...
welcome() {
  ...
  print_brake 70
  output "Pterodactyl panel instaldddddddddddddlation script @ $SCRIPT_RELEASE"
  output ""
